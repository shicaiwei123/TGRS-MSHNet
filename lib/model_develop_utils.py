...
def calc_accuracy(model, loader,args, verbose=False, hter=False):
    """
...
def calc_accuracy_full(model, loader, args, verbose=False, hter=False):
    """
    :param model: model network
    :param loader: torch.utils.data.DataLoader
    :param verbose: show progress bar, bool
...
def train_base(model, cost, optimizer, train_loader, test_loader, args):
    ...
    while epoch < epoch_num:
        ...
        # testing
        result_test = calc_accuracy(model, args=args,loader=test_loader, verbose=True)
