...
parser.add_argument('--method', type=str, default='s2f')

parser.add_argument('--model_name', type=str, default='mnist_cnn_best')
parser.add_argument('--log_name', type=str, default='.csv')
parser.add_argument('--backbone', type=str, default='multi_hallucination_ensemble_infer_dropout')
...
args.name = args.method + "_" +args.pair_modalities[0] + "_" + args.pair_modalities[
    1] + "_" + args.backbone + "_version_" + str(args.version)
